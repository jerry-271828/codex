...
async fn live_app_server_warning_notification_renders_message() {
    ...
    chat.handle_server_notification(
        ServerNotification::Warning(WarningNotification {
            thread_id: None,
            message: "Exceeded skills context budget. All skill descriptions were removed and 2 additional skills were not included in the model-visible skills list.".to_string(),
        }),
        /*replay_kind*/ None,
    );
    ...
    assert!(
        normalized.contains("Exceeded skills context budget."),
